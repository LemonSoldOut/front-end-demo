...
(function (global, factory) {
  ...
  var Flake = /*#__PURE__*/ (function () {
    ...
    function Flake(params) {
      ...
      setStyle(innerFlake, {
        animationName: "snowflake_gid_"
          .concat(params.gid, "_x_")
          .concat(this.innerSize),
      ...
      if (params.rotation) {
        addClass(
          innerFlake,
          "snowflake__inner_rotation" + (Math.random() > 0.5 ? "" : "_reverse")
        );
      }
      ...
      [
        {
           ...
           * @returns {Object}
           */
          value: function getAnimationProps(params) {
    ...
    _createClass(Snowflakes, [
      ...
      },
      {
        ...
        value: function _handleResize() {
          var flakeParams = this._getFlakeParams();
      ...
      {
        key: "_appendContainer",
        value: function _appendContainer() {
          var container = document.createElement("div");
          addClass(container, "snowflakes");
          addClass(container, "snowflakes_gid_".concat(this._gid));
      ...
      },
      {
        ...
        value: function _appendStyles() {
          ...
          this._animationStyleNode = this._injectStyle(
      ...
      {
        key: "_injectStyle",
        value: function _injectStyle(style, container) {
          return injectStyle(
            style.replace(/_gid_value/g, "_gid_".concat(this._gid)),
            container
          );
        },
      },
      {
        key: "_getFlakeParams",
        value: function _getFlakeParams() {
        ...
        value: function _appendFlakes() {
          ...
          this._flakes
            ...
            .forEach(function (flake) {
              flake.appendTo(_this._container);
            });
        },
      },
      {
      ...
      },
      {
        ...
        value: function _getAnimationStyle() {
          var fromY = "0px";
          var toY = this._height() + this.params.maxSize * Math.sqrt(2) + "px";
          var gid = this._gid;
          var css = "@-webkit-keyframes snowflake_gid_"
            .concat(gid, "_y{from{-webkit-transform:translateY(")
            .concat(fromY, ")}to{-webkit-transform:translateY(")
            .concat(toY, ");}}\n@keyframes snowflake_gid_")
            .concat(gid, "_y{from{transform:translateY(")
            .concat(fromY, ")}to{transform:translateY(")
            .concat(toY, ")}}");

          for (var i = 0; i <= Flake.maxInnerSize; i++) {
            var left = Flake.calcSize(i, this.params) + "px";
            css += "@-webkit-keyframes snowflake_gid_"
              .concat(gid, "_x_")
              .concat(
                i,
